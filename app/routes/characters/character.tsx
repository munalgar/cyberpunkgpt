...
export default function CharacterChat() {
  ...
  const handleSendMessage = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      const mockResponse = `This is a simulated response from ${character.name}. In the actual app, this would be generated by the Gemini API based on the character's personality and the conversation context.`;
